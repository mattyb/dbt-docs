...
test("Test getting nodes from a spec (no nodes)", () => {
  expect(
    matcher.getNodesFromSpec(dag, pristine_nodes, undefined, {
      select_at: false,
...
test("Test getting nodes from a spec", () => {
  var matched = matcher.getNodesFromSpec(dag, pristine_nodes, undefined, {
    select_at: false,
    select_parents: true,
    parents_depth: null,
    children_depth: null,
...
test("Test node selection - select all", () => {
  var matched = selectorMethods.selectNodes(dag, pristine_node_map, {
    include: "",
    exclude: "",
    hops: undefined,
